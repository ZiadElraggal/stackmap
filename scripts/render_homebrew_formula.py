...
def build_formula(version: str, sha256: str, repository: str) -> str:
...
def main() -> None:
    ...
    parser.add_argument("--sha256", required=True, help="SHA256 of v<version>.tar.gz release archive")
    ...
    formula = build_formula(args.version, args.sha256, args.repository)
